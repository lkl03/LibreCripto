...
import Intro from '../../../components/Mis Operaciones/Intro'
import Body from '../../../components/Mis Operaciones/Body'
...
export default function Market() {
    ...
    return (
        <>
            <Head>
                <title>LibreCripto | Mis Operaciones</title>
                <meta name="description" content="Consultá tus operaciones de criptomonedas en un mismo lugar. Simple, rápido y seguro con LibreCripto." />
                <meta name="keywords" content="cripto, operaciones, criptomonedas, mercado cripto, LibreCripto" />
