...
import Intro from '../../../components/Mis Chats/Intro'
import Chats from '../../../components/Mis Chats/Chats'
...
export default function Market() {
    ...
    return (
        <>
            <Head>
                <title>LibreCripto | Mis Chats</title>
                <meta name="description" content="Consultá tus conversaciones con otros usuarios de LibreCripto en un mismo lugar. Simple, rápido y seguro con LibreCripto." />
                <meta name="keywords" content="chats, operaciones, conversaciones, registro, mercado cripto, LibreCripto" />
