...
import Intro from '../../../components/Publicar/Intro'
import Body from '../../../components/Publicar/Body'
...
export default function Publicar() {
  ...
  return (
    <>
      <Head>
        <title>LibreCripto | Publicar un anuncio</title>
        <meta name="description" content="Publicá tu anuncio de compra o venta de criptomonedas en LibreCripto de manera fácil y segura. Unite a cientos de usuarios que ya forman parte de la comunidad." />
        <meta name="keywords" content="publicar anuncio, cripto, compra, venta" />
      ...
      <header>
        <div className={`fixed w-full max-w-[1920px] m-auto z-40 bg-black sidebar-shadow`}>
            <div className={`sm:px-60 px-12 ${styles.flexCenter} gap-5`}>
                ...
                <Navbar title="Publicar un anuncio" />
