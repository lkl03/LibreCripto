          ...
          <div class="col-12">
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Mensajes de usuarios por empleo en LibreCripto</h3>
              </div>
              <!-- ./card-header -->
              <?php
              include 'php/connect.php';
              $userdbconsult = mysqli_query($connect, "SELECT * FROM contactos WHERE motivo = 'Empleo' AND solved = '0' ORDER BY contacto ASC");
              ?>
              <div class="card-body">
                                              ...
                                              if($usercontrax != ''){
                                                if($_SESSION['pass'] === $usercontraxpass){
                                                  if($response != ''){
                                                    ...
                                                    if($sqld){
                                                      echo '<script type="text/javascript">';
                                                      echo 'window.location.href = \'empleo.php?id='.$_SESSION['id'].'\';';
                                                      echo '</script>';
