    ...
    <div class="row">
          <div class="col-12">
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Solicitudes de usuarios por ayuda con problemas</h3>
              </div>
              <!-- ./card-header -->
              <?php
              include 'php/connect.php';
              $userdbconsult = mysqli_query($connect, "SELECT * FROM contactos WHERE (motivo = 'Problemas con tu cuenta' OR motivo = 'Problemas con usuarios') AND solved = '0' ORDER BY contacto ASC");
              ?>
              <div class="card-body">
                <table class="table table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <th>Usuario del Contactante</th>
                      <th>Usuario acusado</th>
                      <th>Mensaje</th>
                    </tr>
                  </thead>
                  <tbody>
                  ...
                  ?>
                    <tr data-widget="expandable-table" aria-expanded="false">
                      ...
                      <td><?php echo $lista['userproblem']; ?></td>
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <form action="" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            <input type="hidden" class="form-control" id="username" maxlenght="100" name="username" value="<?php echo $lista['username']?>">
                                          </div>
                                          <div class="form-group">
                                            <input type="hidden" class="form-control" id="userproblem" maxlenght="100" name="userproblem" value="<?php echo $lista['userproblem']?>">
                                          </div>
                                          <div class="form-group">
                                          ...
                                          <?php
                                            if(isset($_POST['rechazarsol'])){
                                              ...
                                              $userproblem = empty($_POST['userproblem']) ? NULL : $_POST['userproblem'];
                                              ...
                                              if($usercontrax != ''){
                                                if($_SESSION['pass'] === $usercontraxpass){
                                                  if($response != ''){
                                                    ...
                                                    if($sqld){
                                                      echo '<script type="text/javascript">';
                                                      echo 'window.location.href = \'ayuda.php?id='.$_SESSION['id'].'\';';
                                                      echo '</script>';
        ...
        $mail->Body = "
         ...
         <h3>Hola, $usernombre.</h3>
                                                      ...
                                                      <p>Si tenés mas dudas por favor no dudes en volver a contactarnos ;)</p>
