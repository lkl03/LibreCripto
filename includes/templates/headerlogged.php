...
$user = $_SESSION['user'];
$ava = mysqli_query($conexion, "SELECT avatar FROM usuarios WHERE user='$user'");
$avat = mysqli_fetch_array($ava);
$avatar = $avat['avatar'];
?>
    <body>
                            ...
                            <div class="accountMenu last">
                                <div class="hiusermini">
                                    ...
                                    <div class="hiuser">
                                            ...
                                            <img class="profpicheader" src="img/profilepics/<?php echo $avatar?>" alt="avatar">
                                        </div>
                                    </a>
