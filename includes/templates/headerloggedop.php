  ...
  gtag('config', 'G-J8JNT9JNLG');
    ...
    <div class="loader"></div>
        ...
        <header class="site-header-log">
                ...
                <div class="menu-movil-log">
                    ...
                    <nav class="navegacion-principal-log clearfix">
                        <ul class="show">
                            ...
                            <ul>
                            <li><a class="messages" href="https://librecripto.com/mychats?user=<?php echo $_SESSION['user'];?>"><?php 
                                if ($avat['newmessages'] == 0){
                                    null;
                                }else{
                                    echo $avat['newmessages'];
                                }
                                ?>
                                <?php
                                if($avat['newmessages'] == 1){
                                    echo 'Nuevo mensaje!';
                                } else if($avat['newmessages'] == 0){
                                    echo 'No hay nuevos mensajes';
                                }else{
                                    echo 'Nuevos mensajes!';
                                }
                                ?><i class="fas fa-comments"></i></a></li>
                                ...
                                <li class="logOut"><a class="logOut" href="php/cerrar_sesion.php">Cerrar Sesión</a></li>
                            </ul>
                        </div>
                            ...
                            <li class="last">
                                ...
                                <li><a class="messages" href="mychats.php?user=<?php echo $_SESSION['user'];?>"><?php 
                                if ($avat['newmessages'] == 0){
                                    null;
                                }else{
                                    echo $avat['newmessages'];
            ...
            <div class="anuncioop animated flash">
                <?php
                $thisuser = $_SESSION['user'];
                $opconsult = ("SELECT usuariosending, opverif FROM operaciones WHERE usertoconfirm='$thisuser' AND opverif='0'");
                $opresult = mysqli_query($conexion, $opconsult);
                $oprow = mysqli_fetch_array($opresult);
                ?>
                <a href="myoperations.php?user=<?php echo $_SESSION['user'];?>">¡Psst! Tenés una operación pendiente con @<?php echo $oprow['usuariosending']?>. ¡Finalizala!</a>
                </div>
    </header>