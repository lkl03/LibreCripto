...
import { logofooter, logo, logobw } from '../../assets'
    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col sm:pt-5 pt-10`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className='flex-1 flex flex-col justify-start mr-10'>
          <img src={logobw.src} alt="hoobank" className='w-[200px] h-[auto] grayscale object-contain' />
          {!user ? <div className="ss:my-0 my-4 min-w-[150px]">
